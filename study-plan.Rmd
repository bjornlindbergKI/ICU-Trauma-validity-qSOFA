...
Using the training sample the optimal cutoffs for the logistic regression was found maximizing the youden index. The optimal cutoffs where `r boot.cis$cut.rr[["pe"]]`, `boot.cis$cut.rr[["pe"]]` and 14 for SPB, RR and GCS respectively. and the corresponding confidence intervals can be seen in table 2
...
|              | ICI(95% CI)        | Diff(95% CI)                | AUC (95%CI)    |
|--------------|--------------------|-----------------------------|----------------|
