...
The TITCO cohort included `r results$n.cohort` patients, from which `r results$n.younger.than.18` where excluded for being under the age of 18 leaving `r results$n.adults`. Furthermore 5686 patients where excluded due to missing and non recorded data: 
