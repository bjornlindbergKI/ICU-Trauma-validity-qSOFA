...
Introduction 
============
Trauma is defined as the clinical entity composed of both physical injury and the body’s associated response. [MeSH] Trauma patients are a heterogeneous group with a wide range of different causes the most prominent ones are traffic related injuries, falls, self-harm, interpersonal violence and burns. Trauma is a global health problem and the total number of injuries<!-- Do you mean patients with injuries?--> is estimated to be at least 520 million cases per year. [@James2020] 
...
Because of the composition and context of the TITCO database the results are likely to be generalizable to similar settings, that is to other urban hospitals of similar economic and resource level. It is not clear whether the results can be used in rural settings or setting with higher or lower resource levels. 
...
Another comparison can be made to that of the development In its original context the qSOFA model had an AUC for mortality of 0.66 for patients treated at the ICU and 0.81 for patients without ICU encounters. The original OR for the parameters can be seen in table 2. (orginalkällan)<!-- What are you comparing this to? Are you comparing the findings of Miyamoto with the findings of the original qSOFA paper? This needs to be clarified --> 

Although these studies looked at mortality and not ICU admission one can see that both the mentioned studies had a comparable but slightly higher AUC and a higher OR than can be shown in this study. This is to be somewhat expected since it can be argued that although there is a connection between ICU admission and mortality through severity of that patients condition there were patients who died without being treated in the ICU<!-- Do you mean that both probability of mortality and probability of ICU admission can be considered measures of injury severity?-->. The reason for this<!-- Reasons for what exactly?--> is not certain but one can argue that this is because the patients condition was such that the patients either died before they could be admitted to the ICU, the doctors decided that intensive care would not be of benefit for the patient, or due to a lack of resources or ICU beds such that patients had to be prioritized for intensive care and not all patients who would benefit from it got admitted to the ICU. For context the number of ICU beds per 100 000 people is 2.3 in India compared with for example 7.3 in Japan. (Källa 19)
